...
export class Jumping extends State {
  ...
  handleInput(inputKeys) {
    if (this.game.player.vSpeed > this.game.player.weight) {
...
export class Rolling extends State {
  ...
  handleInput(inputKeys) {
    ...
    if (!inputKeys.includes(" ") && this.game.player.onGround()) {
      this.game.player.setState(states.RUNNING, 1);
    } else if (!inputKeys.includes(" ") && !this.game.player.onGround()) {
      this.game.player.setState(states.FALLING, 1);
    } else if (
      inputKeys.includes(" ") &&
